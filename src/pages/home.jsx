...
import mainLogo from '../assets/argentBankLogo.png'; // Import du logo principal
		...
		<>
			<div className='master-contain'>
				<nav className="main-nav">
					...
					<div>
						{/* Utiliser Link au lieu de <a> pour le lien de connexion */}
						<Link to="/home/sign-in" className="main-nav-item">
